...
SOURCE_ALLOWLIST = {
    ...
    "ThnContentHubV2PublisherFunction": (
        ...
        "content_hub_v2_projection.py", "content_hub_v2_projection_store.py",
        "content_hub_v2_preparation.py", "content_hub_v2_state_keys.py",
        "content_hub_v2_editor_model.py", "content_hub_v2_authorization.py",
        "content_hub_v2_actor_fence.py", "content_hub_v2_registry_fence.py",
...
RUNTIME_REQUIREMENTS = {
    "ThnContentHubV2InvalidationWorkerFunction": "requirements.txt",
    "ThnContentHubV2PreparedOrphanCollectorFunction": "requirements.txt",
    "ServiceBindingRegistryV2MutationFunction": "requirements.txt",
    "ThnContentHubV2AuthoringFunction": "requirements.txt",
    "ThnContentHubV2PublisherFunction": "requirements.txt",
    "ThnContentHubV2PrivateAssetCollectorFunction": "requirements.txt",
